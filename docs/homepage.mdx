...
### 🚀 Getting Started
If you're new, head to the **Getting Started** guide for how to invite the bot and run your first commands.
...
<div className="md-button-column">
  <Link className="button button--primary" href="https://github.com/asteriasmoons/pandoryx-bot/issues/2#issue-3166322020">
    <span className="btn-emoji" aria-hidden="true">💡</span>
    <span>Feature Requests</span>
  </Link>
  <Link className="button button--primary" href="https://github.com/asteriasmoons/pandoryx-bot/issues/1#issue-3166312503">
    <span className="btn-emoji" aria-hidden="true">🐛</span>
    <span>Bug Reports</span>
  </Link>
  <Link className="button button--primary" href="https://discord.gg/jS5eTjhK7R">
    <span className="btn-emoji" aria-hidden="true">💬</span>
